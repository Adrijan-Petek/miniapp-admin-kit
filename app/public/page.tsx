  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <h1 className="text-4xl font-bold mb-4 text-black">Welcome to MiniApp</h1>
        <p className="text-lg text-gray-600 mb-8">Play games, earn rewards, and claim your tokens!</p>
